 ...
 *
 * Cette classe permet d'effectuer les traitements attendus sur la classe ArticleVendu
 */
public class ArticleVenduManager {
	 ...
	 */
	public ArticleVendu ajouter(String nom, String description, LocalDate dateDebut, LocalDate dateFin, int miseAPrix, Categorie categorie) throws BusinessException
	...
	/**
	 * Cette méthode permet de vérifier les règles à respecter sur la variable desvription.
