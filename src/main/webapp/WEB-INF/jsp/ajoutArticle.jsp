...
<body>
	...
	<form action="<%=request.getContextPath()%>/ServletAjoutArticle"
		method="post">
		<label for="idNom">Nom : </label><input type="texte" id="idNom"
			name="nom"
			value="<%=listeCodesErreur != null ? request.getParameter("nom") : ""%>" />
		<br /> <label for="idDescription">Description : </label><input
			type="texte" id="idDescription" name="description"
			value="<%=listeCodesErreur != null ? request.getParameter("description") : ""%>" />
		<br /> <label for="idCategorie">Catégorie : </label> <select
			id="idCategorie" name="categorie">
			<option value="HIGH-TECH">HIGH-TECH</option>
			<option value="MAISON">MAISON</option>
			<option value="JARDIN">JARDIN</option>
			<option value="AUTO-MOTO">AUTO-MOTO</option>
		</select> <br /> <label for="idDateDebut">Date de début : </label><input
			type="date" id="idDateDebut" name="date_debut"
			value="<%=listeCodesErreur != null ? request.getParameter("date_debut") : ""%>" />
		<br /> <label for="idDateFin">Date de fin : </label><input type="date"
			id="idDateFin" name="date_fin"
			value="<%=listeCodesErreur != null ? request.getParameter("date_fin") : ""%>" />
		<br /> <label for="idMiseAPrix">Mise à prix : </label><input
			type="number" id="idMiseAPrix" name="mise_a_prix"
			value="<%=listeCodesErreur != null ? request.getParameter("mise_a_prix") : ""%>" />
